...
cuda_v10_dll_path = r'C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v10.2\bin'
add_dll_directory(cuda_v10_dll_path)
...
KERNEL_TYPE = ['linear', 'polynomial', 'rbf', 'rbf_1', 'rbf_2', 'rbf_3', 'sigmoid', 'precomputed']
